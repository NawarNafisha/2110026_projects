...
<body>
    ...
    <i class="bi bi-buildings-fill"></i> Hotels
</a>

                    </li>
                    <li>
                        <a href="<?php echo base_url('/bookings')?>"><i class="bi bi-backpack-fill"></i> Bookings</a>
                    </li>
                    <li>
          ...
          <button><i class="bi bi-power"></i><a href="<?= base_url('/'); ?>" style="color:white; text-decoration:none;">Back</a></button>
