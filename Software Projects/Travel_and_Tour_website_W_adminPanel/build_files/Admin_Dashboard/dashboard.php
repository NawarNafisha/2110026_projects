        ...
        <aside>
            ...
            <div class="data-card">
                <div class="card">
                    ...
                    <div class="cont">
                        <h1><span id="bookings"></span> <sub><i class="bi bi-arrow-up-right"></i>100%</sub></h1>
                        <h5>Bookings</h5>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="cont">
                        <h1><span id="hotel"></span> <sub><i class="bi bi-arrow-down-right"></i>100%</sub></h1>
                        <h5>Hotels</h5>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="cont">
                        <h1><span id="user"></span> <sub><i class="bi bi-arrow-up-right"></i>100%</sub></h1>
                        <h5>Users</h5>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="cont">
                        <h1><span id="revenue"></span> <sub><i class="bi bi-arrow-up-right"></i>100%</sub></h1>
                        <h5>Revenue</h5>
                    </div>
                </div>
            </div>
                                ...
                                try {
                                    ...
                                    if (data) {
                                        data.forEach(element => {
                                            ...
                                            card.innerHTML = `
                                <span><img src="<?php echo base_url('/assets/images/Hotels-photos/'); ?>${element.poster}" alt="${element.hotelName}" > ${element.hotelName}</span><span>${Math.floor((element.count/element.total * 100))}%</span>
                                `;
                                ...
                                try {
                                    ...
                                    if (data) {
                                        data.forEach(element => {
                                            let card = document.createElement('li');
                                            card.innerHTML = ` <span>
                                            <img src="<?php echo base_url('/assets/images/Hotels-photos/'); ?>${element.poster}" alt="${element.name}" >
                                                  ${element.name} &nbsp; <b>${element.city}</b>
                                                    </span>
                                                 `;
                            ...
                            let fetchAllBookings = async () => {
                                try {
                                 ...
                                 <div class="profile_det">
                                    <img src="<?php echo base_url('/assets/images/Hotels-photos/'); ?>${element.poster}" alt="">
                                    <div class="title_date">
                                        <h6>${element.booking_username}</h6>
                                        <p>${element.create_at.split(' ')[0].split('-')[2]}  ${monthsShort[+element.create_at.split(' ')[0].split('-')[1] - 1]}  ${element.create_at.split(' ')[0].split('-')[0]}</p>
                                    </div>
                                </div>
