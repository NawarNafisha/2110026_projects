        ...
        <aside>
            ...
            <div class="search_add">
                ...
                <button id="form_btn"><i class="bi bi-plus-circle-fill"></i>Add</button>
            ...
            <div class="add_form" id="hotelAdd">
                <form action="#">
                    ...
                    <div class="card">
                        ...
                        <input type="text" placeholder="description" id="dec">
                    </div>
                    ...
                    <div class="card">
                        ...
                        <input type="text" placeholder="breakfast, lunch" id="food">
                    </div>
            ...
            <div class="add_form" id="hotelEdit">
                <form action="#">
                    ...
                    <div class="card">
                        <label for="">Description</label>
                        <input type="text" placeholder="description" id="dec_edit">
                    </div>
                    ...
                    <div class="card">
                        <label for="">Food</label>
                        <input type="text" placeholder="breakfast, lunch" id="food_edit">
                    </div>


                    <div class="card">
                        <label for="">Poster</label>
                        <input type="file" placeholder="poster.jpg" id="poster_edit" onchange="uploadImage('poster' , 'preview')">
                        <img src="" id="preview_edit">
                    </div>


                    <div class="card">
                        <label for="">Room Poster 1</label>
                        <input type="file" placeholder="abc.jpg, abc1.jpg" id="poster1_edit" onchange="uploadImage('poster1' , 'preview1')">
                        <img src="" id="preview1_edit">
                    </div>

                    <div class="card">
                        <label for="">Room Poster 2</label>
                        <input type="file" placeholder="abc.jpg, abc1.jpg" id="poster2_edit" onchange="uploadImage('poster2' , 'preview2')">
                        <img src="" id="preview2_edit">
                    </div>
                            ...
                            if (data) {
                                ...
                                data.forEach(element => {
                                    ...
                                    card.innerHTML = ` 
                                             ...
                                             <td>${element.id}</td>
                    <td><img src="<?php echo base_url('/assets/images/Hotels-photos/'); ?>${element.poster}" alt="${element.name}"></td>
                    <td>${element.name}</td>
                    <td>${element.city}</td>
                    <td>${element.mrp}</td>
                    <td>${element.discount}</td>
                    <td>${element.room}</td>
                    <td><button class="edit"  data="${element.id}?${element.name}?${element.description}?${element.city}?${element.rate}?${element.mrp}?${element.discount}?${element.location}?${element.lat}?${element.log}?${element.services}?${element.food}?${element.poster}?${element.room_addHotelImages}?${element.room}"><i class="bi bi-pencil-square"></i>Edit</button></td> 
                    ...
                    let edit = () => {
                        Array.from(document.getElementsByClassName('edit')).forEach((el) => {
                            el.addEventListener('click', () => {
                                ...
                                document.getElementById('preview_edit').src = '<?php echo base_url('/assets/images/Hotels-photos/'); ?>' + data[12].replaceAll(' ', '');
                                document.getElementById('preview1_edit').src =
                                    '<?php echo base_url('/assets/images/Hotels-photos/'); ?>' + data[13].split(',')[0].replaceAll(' ', '');

                                document.getElementById('preview2_edit').src =
                                    '<?php echo base_url('/assets/images/Hotels-photos/'); ?>' + data[13].split(',')[1].replaceAll(' ', '');
